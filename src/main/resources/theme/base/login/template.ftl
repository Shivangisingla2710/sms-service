...
<#assign pageDataId = (pageId??)?then("login-" + pageId, "login")>
<body class="${properties.kcBodyClass!}" data-page-id="${pageDataId}">
<div class="${properties.kcLoginClass!}">

    <div id="kc-header" class="${properties.kcHeaderClass!}">
        <div id="kc-header-wrapper"
             class="${properties.kcHeaderWrapperClass!}">
             <img src="${url.resourcesPath}/img/logo.png" alt="Logo" style="height:160px;"/>
             </div>
    </div>
